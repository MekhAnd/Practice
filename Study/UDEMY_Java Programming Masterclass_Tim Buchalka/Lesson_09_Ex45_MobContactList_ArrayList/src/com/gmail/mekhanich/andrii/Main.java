...
public class Main {
    public static void main(String[] args) {
        MobilePhone my = new MobilePhone("Andriy");

        Contact one = new Contact("Liudmila", "0930544054");
        Contact two = new Contact("Kate", "0935606560");
        Contact three = new Contact("Andrii", "0636006565");
        Contact four = new Contact("Liudmila", "0930544054");
        Contact five = new Contact ("Liudmila", "0674333033");
        Contact six = new Contact ("Yuriy", "0675003600");
        Contact seven = new Contact ("Andrii", "0675000499");
        Contact eight = new Contact ("Andrii", "00000000009");


        System.out.println("my.addNewContact");
        System.out.println("************");
        System.out.println(my.addNewContact(one));
        System.out.println(my.addNewContact(two));
        System.out.println(my.addNewContact(three));
        System.out.println(my.addNewContact(four));
        System.out.println(my.addNewContact(six));
        System.out.println("************");

        my.printContacts();

        System.out.println("my.updateContact");
        System.out.println("************");
        System.out.println(my.updateContact(one, five));
        System.out.println(my.updateContact(three, seven));
        System.out.println(my.updateContact(six, eight));
...
//        System.out.println("my.removeContact");
//        System.out.println("************");
//        System.out.println(my.removeContact(six));
//        System.out.println("************");
//
//        my.printContacts();
//
//        System.out.println("my.findContact");
//        System.out.println("************");
//        System.out.println(my.findContact(three));
//        System.out.println("************");
//
//        my.printContacts();
//
        System.out.println("my.queryContact");
        System.out.println("************");
        System.out.println(my.queryContact("Andrii"));
        System.out.println("************");
    }
}
