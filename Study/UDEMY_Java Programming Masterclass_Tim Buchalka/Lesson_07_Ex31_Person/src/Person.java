...
//               (this.getLastName().isEmpty() ? "" : this.getLastName()) :
//               (this.getLastName().isEmpty() ? this.getFirstName(): this.getFirstName() + " " + this.getLastName());
...
//            this.getFirstName()
//                ((this.getFirstName().isEmpty() && this.getLastName().isEmpty()) ? "" : " ") + (this.getLastName().isEmpty() ? "" : this.getLastName())
