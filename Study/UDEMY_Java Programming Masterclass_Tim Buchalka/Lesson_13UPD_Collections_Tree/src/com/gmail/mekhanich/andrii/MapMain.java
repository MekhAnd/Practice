...
public class MapMain {
    public static void main(String[] args) {
        ...
        System.out.println(contacts.get("Cha Brown"));
...
// LONG SAME
//                (prev, current) ->prev.mergeContactData(current)
//                    System.out.println("prev: " + prev + " : current " + current);
//                    Contact merged = prev.mergeContactData(current);
...
//            contacts.compute(contactName, (k,v)-> new Contact(k)); two empty contacts
        ...
        contacts.replaceAll((k,v)->{
            ...
            v.replaceEmialExists("DDuck@funplace.com", newEmail);
            return v;
        });
        contacts.forEach((k,v)-> System.out.println("key = " + k +", value = " + v));
        ...
        if(success){
            ...
            System.out.printf("Did not match both key: %s and value: %s %n".formatted("Daisy Duck", replacedContact));
        }
        ...
        if(success){
            ...
            System.out.printf("Did not match both key: %s and value: %s %n".formatted("Daisy Duck", daisy));
        }
