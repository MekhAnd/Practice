...
// Also, all of these cars have an engine and four wheels. So the other two fields should be set
// to default values.
//
...
// constructor for object instantiation. Each of these classes will override the three parent methods
...
////    You should paste the code from each of your classes into the respective
//      class file in the code evaluator.