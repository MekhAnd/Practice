...
//        int needToBuyBuckets = 0;
//
//        if (width <= 0 || height <= 0 || areaPerBucket <= 0 || extraBuckets < 0) needToBuyBuckets = -1;
//        else {
//            double area = width * height;
//            needToBuyBuckets = (int) Math.ceil((area / areaPerBucket) - extraBuckets);
//
////            System.out.println(area + " " + needToBuyBuckets);
//        }
//
//
//        return needToBuyBuckets;
//    }
//
//    public static int getBucketCount(double width, double height, double areaPerBucket) {
//        int needToBuyBuckets = 0;
//
//        if (width <= 0 || height <= 0 || areaPerBucket <= 0) needToBuyBuckets = -1;
//        else {
//            double area = width * height;
//            needToBuyBuckets = (int) Math.ceil((area / areaPerBucket));
//        }
//
//
//        return needToBuyBuckets;
...
//        int needToBuyBuckets = 0;
//
//        if (area <= 0 || areaPerBucket <= 0) needToBuyBuckets = -1;
//        else {
//            needToBuyBuckets = (int) Math.ceil((area / areaPerBucket));
//        }
//
