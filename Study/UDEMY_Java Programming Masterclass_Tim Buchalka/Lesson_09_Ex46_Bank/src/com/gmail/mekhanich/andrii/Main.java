...
//    -  addBranch(), has one parameter of type String (name of the branch) and returns a boolean. It returns true if
//    the branch was added successfully or false otherwise.
...
//    and returns a boolean. Return true if the branch exists or false otherwise. This method prints out a list of customers.
//
//→ TEST CODE
//
//    Bank bank = new Bank("National Australia Bank");
