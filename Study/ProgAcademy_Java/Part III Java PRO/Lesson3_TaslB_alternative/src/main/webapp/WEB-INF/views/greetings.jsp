	...
	<div class="body">
        ...
        <div class="body_form">
        	<div class="body_form__top">Форма входа</div>
				<form class="body_form__form" action="/greetings.do" method="POST">
					 <button class="body_form__form-button" name= "status" value="registration">Зарегистрироваться</button>
					 <button class="body_form__form-button" name= "status" value="autorisation">Есть учетная запись</button>
				</form>
             </div>
